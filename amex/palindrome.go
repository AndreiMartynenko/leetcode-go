...
Examples
given N = 5, K= 2  your function may return “abbba”.  there are many other possibilities for example it could also return “zdzdz”.  on the other hand “aaaaa”  is an incorrect answer is it contains only one distinct letter.
